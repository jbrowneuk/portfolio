...
<div class="page-section background-alternate about-block">
    <header>
        <div class="container mugshot-container">
            <div class="fancy-heading-container blue">
                <h2>Background</h2>
            </div>
            <img class="mugshot" src="/assets/images/about/jason2019.jpg" alt="">
        </div>
    </header>
    <div class="container">
        <div id="skills-grid">
            <!-- Work, column 1 -->
            <article id="work-experience" class="column">
            ...
            <!-- Skills, column 2 -->
            <article id="skill-set" class="column">
                <h3>Skills</h3>

                <section>
                    <h4>Code</h4>
                    <div class="experience-charts">
