...
<footer id="page-footer">
  <div class="container">
    <svg id="backdrop-icon" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><use href="#sitesheet-logo"></use></svg>
    <div id="site-map">
      <svg id="site-icon" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><use href="#sitesheet-logo"></use></svg>
      <div class="map-list">
